 ...
 *
 */
public class ClusterListPathAttributeCodecHandler extends PathAttributeCodecHandler<ClusterListPathAttribute> {
	 ...
	 */
	@Override
	public void encodeValue(ByteBuf buffer, ClusterListPathAttribute attr) {
