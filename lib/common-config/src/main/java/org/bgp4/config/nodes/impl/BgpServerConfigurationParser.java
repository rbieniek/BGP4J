 ...
 */
@Singleton
public class BgpServerConfigurationParser {

	private @Inject ServerConfigurationParser serverConfigurationParser;
	
	public BgpServerConfiguration parseConfiguration(HierarchicalConfiguration config) throws ConfigurationException {
