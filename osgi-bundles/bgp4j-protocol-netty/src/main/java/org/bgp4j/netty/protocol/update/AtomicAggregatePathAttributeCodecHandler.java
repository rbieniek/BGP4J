 ...
 *
 */
public class AtomicAggregatePathAttributeCodecHandler extends PathAttributeCodecHandler<AtomicAggregatePathAttribute> {
	 ...
	 */
	@Override
	public void encodeValue(ByteBuf buffer, AtomicAggregatePathAttribute attr) {
	}
