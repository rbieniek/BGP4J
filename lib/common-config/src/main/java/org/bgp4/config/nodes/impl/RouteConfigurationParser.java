...
public class RouteConfigurationParser {
	...
	public RouteConfiguration parseConfiguration(HierarchicalConfiguration config) throws ConfigurationException {
		...
		return new RouteConfigurationImpl(parseNlri(prefix), pathAttrParser.parseConfiguration(pa.get(0)));
	}
	
	private NetworkLayerReachabilityInformation parseNlri(String rep) throws ConfigurationException {
