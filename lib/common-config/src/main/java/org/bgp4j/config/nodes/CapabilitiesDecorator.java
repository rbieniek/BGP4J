...
public class CapabilitiesDecorator implements Capabilities {
	...
	public CapabilitiesDecorator(Capabilities decorated) {
	...
	public int hashCode() {
		...
		for(Capability cap : getRequiredCapabilities())
			hcb.append(cap).append(false);

		for(Capability cap : getOptionalCapabilities())
